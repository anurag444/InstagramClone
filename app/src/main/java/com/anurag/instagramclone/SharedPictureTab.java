...
public class SharedPictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_shared_picture_tab,
                container, false);


        imgShare = view.findViewById(R.id.imgshare);
        edtDescription = view.findViewById(R.id.imgDescription);
        btnShareImage = view.findViewById(R.id.btnshare);

        imgShare.setOnClickListener(SharedPictureTab.this);
        btnShareImage.setOnClickListener(SharedPictureTab.this);
            ...
            case R.id.btnshare:
                ...
                if (receivedImageBitmap != null) {
                    ...
                    if (edtDescription.getText().toString().equals("")) {
                        Toast.makeText(getContext(), "Error: You must specify a description."
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e == null) {
                                    Toast.makeText(getContext(), "Done!!!", Toast
                                            .LENGTH_SHORT).show();
                                } else {
                    ...
                    Toast.makeText(getContext(), "Error: You must select an image."
                            , Toast.LENGTH_SHORT).show();
